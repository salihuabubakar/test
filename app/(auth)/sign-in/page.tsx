      ...
      <div className="flex flex-col items-center justify-center mx-auto  ">
        <div className="">
          ...
          <div className="text-center">
            <h1 className="font-clashSemiBold text-[24px] md:text-[32px]">
              Welcome Back
            </h1>
            ...
            <div className="flex items-center justify-center gap-x-3 bg-white   p-5 cursor-pointer">
              ...
              <p className="font-clashSemiBold  text-cdneutral-black">
                Sign In with Google
              </p>
            </div>
            <div
              className={
                "flex flex-row justify-center items-center mt-4 gap-x-3"
              }
            >
              <div
                className={"flex-1 w-[220px] md:w-[0px] h-[1px] bg-[#CCCCCC4D]"}
              />
